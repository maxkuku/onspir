    ...
    return (
        ...
        <div key={props.ID} className='itemJur'>
            <div className='itemJur__wrap'>
                ...
                <div className='itemJur__detail_block'>
                    ...
                    <div className='itemJur__details'>Тип: <span>{ (props.CR_TYPE === 0) ? "Иск нам" : "Иск от нас" }</span></div>

                    {/* 0 - sozdan, 1 - v processe, 2 - my vyigrali, 3 - my proigrali, 4 - mirovoe, 5 - perenos */}
                    <div className='itemJur__details'>Статус: <span>{ (props.CR_STATUS === 0) ? "Создан" : (props.CR_STATUS === 1) ? "В процессе" : (props.CR_STATUS === 2) ? "Мы выиграли" : (props.CR_STATUS === 3) ? "Мы проиграли" : (props.CR_STATUS === 4) ? "Мировое" : (props.CR_STATUS === 5) ? "Перенос" : "-" }</span></div>
                    ...
                    <div className='itemJur__details'>Имя судьи: <span>{props.JUDGE_NAME}</span></div> 
                ...
                <div className='itemJur__change_wrap'>
                    ...
                    <div className='itemJur__change' onClick={ ()=> setOpen(() => true) }>
                        Изменить
                    </div>
                </div>
            </div>
